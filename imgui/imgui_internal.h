...
enum ImGuiInputRepeatMode_
{
    ImGuiInputRepeatMode_Down,
    ImGuiInputRepeatMode_Pressed,
    ImGuiInputRepeatMode_Released,
    ImGuiInputRepeatMode_Repeat,
    ImGuiInputRepeatMode_RepeatSlow,
    ImGuiInputRepeatMode_RepeatFast
};
typedef ImGuiInputRepeatMode_ ImGuiInputRepeatMode;
...
namespace ImGui
{
    ...
    IMGUI_API float         GetNavInputAmount(ImGuiNavInput n, ImGuiInputRepeatMode mode);
    IMGUI_API ImVec2        GetNavInputAmount2d(ImGuiNavDirSourceFlags dir_sources, ImGuiInputRepeatMode mode, float slow_factor = 0.0f, float fast_factor = 0.0f);
    ...
    inline bool             IsNavInputPressed(ImGuiNavInput n, ImGuiInputRepeatMode mode) { return GetNavInputAmount(n, mode) > 0.0f; }
    inline bool             IsNavInputPressedAnyOfTwo(ImGuiNavInput n1, ImGuiNavInput n2, ImGuiInputRepeatMode mode) { return (GetNavInputAmount(n1, mode) + GetNavInputAmount(n2, mode)) > 0.0f; }
